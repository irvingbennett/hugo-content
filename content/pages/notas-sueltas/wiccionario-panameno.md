...
author: Rompy
date: "2012-10-10T00:02:32+00:00"
guid: http://hbx.wvf.mybluehost.me.s39296.gridserver.com/?page_id=2258
parent_post_id: "2165"
post_id: "2258"
title: Wiccionario Panameño
url: /notas-sueltas/wiccionario-panameno
...
- **Barriada Bruja o barrio Brujo** = [Asentamiento Humano](http://es.wiktionary.org/w/index.php)") Informal/ Villa mísera o Favela.
- **Batería** = papel con respuestas de un examen
- **Berrinche** = Armar un escándalo o necedad _\[Ejm. Ese niño tiene un berrinche\]_. Olor fuerte a orine _\[Ejm. Este baño huele a berrinche\]_.
...
- **Bravos de Boston** = El mejor de una profesión. dedicado a los bravos de boston de 1914. [\[1\]](http://www.univision.com/content/content.jhtml)
...
- **Bueno(a)** = que esta muy bonita o bonita y tiene buen fisico, _\[ejm. Mami 'tas wena\]_; también "pay" (como en "es un pay").
...
- **Camarón** = actividad extracurricular que permite a un individuo ganar dinero extra. Su origen se remonta a los tiempos en que los gringos le decían a los locales _"Come around..."_ (pásate por aquí). _\[Ejm. Voy a hacer un camarón\]_
...
- **Chuchita** = véase _Congo_. _\[Ejm. Te 'tan (están) cogiendo de congo!!!\]_
- **Chachai** = Vestido de niña.
- **Chambón** = Torpe
- **Chen chen** = Dinero
- **Chicha** = Refresco o bebida fermentada. (Esta palabra, recogida por la [RAE](http://es.wiktionary.org/w/index.php)") y de etimología panameña es usada en Centroamérica, Chile y Perú, con ciertas variaciones)
- **Chinguear** = apostar
...
- **Culear** = manera vulgar de decir tener relaciones sexuales o [sexo](http://es.wiktionary.org/wiki/sexo) con una persona
...
- **Cueco (a)** = [homosexual](http://es.wiktionary.org/wiki/homosexual) o [lesbiana](http://es.wiktionary.org/wiki/lesbiana)
...
- **Guapin/Juatapin** = Saludo que indica que pasa. Del inglés _What happened? / What is happening?_.
...
- **Huevear** = Perder el tiempo de la peor forma. _\[Ejm. Pónte a trabajá y deja de 'ta webiando!!!\]_
...
- **Limpio (a)** = Sin dinero.
- **Lleca** = [traspalante](http://es.wiktionary.org/w/index.php)") derivado de Calle
...
- **Ñecks** = Versión decente de "mierda". _\[Ejm. Te wa (voy a) sacá la ñecks!!!\]_
...
- **Pa'lante** = reducción derivada de _para adelante_
...
- **Pajizo/a** = persona que se masturba constantemente; persona que muestra debilidad ante una actividad física. _\[Ejm. Jo! no puedes ni levantar eso... 'tas pajizo!!!\]_.
...
- **Patacón** = Popular acompañamiento de comida, el cual consiste en rodajas de [plátano](http://es.wiktionary.org/wiki/pl%C3%A1tano) aplastadas y luego fritas.
...
- **Salado (a)** (normalmente se dice "sala'o (a)")= Persona que tiene mala suerte. Ejm. _Mario tu **estás salado** en la lotería._
...
- **Plena** = Usado para canciones/ritmos de [reggae](http://es.wiktionary.org/wiki/reggae) pero también usada para otros géneros cuando la cancion es buena.
- **Pinta / fría** = cerveza
...
- **Sólido** =Significa _excelente_. También "chévere".
...
- **[Cholywood](http://es.wiktionary.org/w/index.php)")** = Forma graciosa, despectiva o una manera para definir la farándula panameña.
...
- **Tortillera** = [lesbiana](http://es.wiktionary.org/wiki/lesbiana)
...
- **Qué xopá** = _[traspalante](http://es.wiktionary.org/w/index.php)")_, derivado de _¿qué paso?_
...
- **Vaina** = Utilizado como comodín en conversaciones, usado por _cosa_ (también usado en otros países con el mismo significado).
...
- **Zambito(a)** = expresión de las provincias de Herrera y Los Santos, significa _niño o niña_.
...
- **Chiwiz** = (orignario de la palabra _chesse wiz_) Una merienda.
